...
$sql_bv = "SELECT * FROM tbl_baiviet WHERE tbl_baiviet.id_danhmuc ='5' ORDER BY id DESC";
$query_bv = mysqli_query($mysqli, $sql_bv);
$row = mysqli_fetch_array($query_bv);
$sql_dmbv = "select * from tbl_danhmucbaiviet where id_baiviet='5'";
$query_dmbv = mysqli_query($mysqli, $sql_dmbv);
$row_dm = mysqli_fetch_array($query_dmbv);
//get ten danh muc
...
-->
		<div class="row">
			...
			<div class="span9">
				...
				<div class="well well-small">
					<h1> <?php echo $row_dm['tendanhmuc_baiviet'] ?></h1>
					<hr class="soft" />
					<ul>
						<?php
