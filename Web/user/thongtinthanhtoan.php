		...
		<div class="row">
			<div class="span12">
				...
				<div class="well well-small">
					...
					<form class="" method="POST" target="blank" enctype="application/x-www-form-urlencoded" action="../user/xulythanhtoanmomo.php">
					...
					<form class="" method="POST" target="blank" enctype="application/x-www-form-urlencoded" action="../user/xulythanhtoanmomo_atm.php">
						<img style="max-width: 3.5%" src="../admincp/img/MoMo_Logo.png">
						<input type="hidden" name="tongtien_vnd" value="<?php echo $tongtien_vnd ?>">
