...
if(isset($_POST['themsanpham'])){
	...
	if(!empty($_FILES['hinhanh']['name'])){
		...
		$sql= "UPDATE tbl_sanpham SET tensanpham='".$tensanpham."',masp='".$masp."',giasp='".$giasp."',soluong='".$soluong."',hinhanh = '$hinhanh',tomtat='".$tomtat."',noidung='".$noidung."',tinhtrang='".$tinhtrang."',id_danhmuc='".$danhmuc."' where id_sanpham='$_GET[idsanpham]'" ;
