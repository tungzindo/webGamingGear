...
elseif(isset($_POST['suabaiviet'])){
	...
	if(!empty($_FILES['hinhanh']['name'])){
		...
		$sql= "UPDATE tbl_baiviet SET tenbaiviet='".$tenbaiviet."',hinhanh = '$hinhanh',tomtat='".$tomtat."',noidung='".$noidung."',tinhtrang='".$tinhtrang."',id_danhmuc='".$danhmuc."' where id='$_GET[idbaiviet]'" ;
