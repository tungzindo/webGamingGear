...
?>
 <form method="POST" action="modules/quanlybaiviet/xuly.php?idbaiviet=<?php echo $row['id'] ?>" enctype="multipart/form-data">
 	<thead class="thead-dark">
		    <tr>
		      <th colspan="2">Sửa bài viết</th>
		    </tr>
  	  </thead>
	  <tr>
	  	<td>Tên bài viết</td>
	  	<td><input type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" value="<?php echo $row['tenbaiviet'] ?>" name="tenbaiviet"></td>
	  </tr>
	   <tr>
	  	<td>Hình ảnh</td>
	  	<td>
	  ...
	  <tr>
	   ...
	   <tr>
	    <td colspan="2"><input class="btn btn-outline-warning" type="submit" name="suabaiviet" value="Sửa bài viết"></td>
	  </tr>
 </form>
 <?php
 } 
